...
pub struct Logs {
    ...
    pub isolated_cherry_cut_opt: u64,
    pub saturated_cherry_cut_opt: u64,
...
impl Logs {
    pub fn print_logs_after_k(&self, k: usize) {
        ...
        for (name, val) in [
            ...
            ("isolated_cherry_cut_opt", self.isolated_cherry_cut_opt),
            ("saturated_cherry_cut_opt", self.saturated_cherry_cut_opt),
